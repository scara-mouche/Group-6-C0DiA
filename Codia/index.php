...
if(isset($_SESSION['error'])){
    echo "<div id='error-message' style='color:#ff6b6b; font-size:14px; margin-top:10px;'>".$_SESSION['error']."</div>";
    unset($_SESSION['error']); // clear after showing
} else {
    echo "<div id='error-message' style='color:#ff6b6b; font-size:14px; margin-top:10px;'></div>";
}
?>
...
<div class="create">
<button type="button" onclick="location.href='sign.php'">Create Account</button>
</div>
