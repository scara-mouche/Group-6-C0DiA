...
<div class="main">
    ...
    <div class="login">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST">
            ...
            <div class="create">
                <button type="button" onclick="location.href='<?php echo e(route('signup')); ?>'">Create Account</button>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Codia\laravel_app\resources\views/home.blade.php ENDPATH**/ ?>